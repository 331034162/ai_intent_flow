-- ============================================================================
-- AI Intent Flow 数据库初始化数据脚本（仅数据，无建表语句）
-- 表结构请以 ai_intent_flow.sql 为准（2026-08-31 对齐）
-- 包含数据：zb_ai_workflow(3)、zb_conversation_nodes(3)、zb_node_prompt(7)、
--   zb_node_prompt_ver_ctrl(9)、zb_llm_models(1)
-- ============================================================================
